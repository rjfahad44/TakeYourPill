...
fun Context.getColorDrawableFromAttr(resid: Int): ColorDrawable {
    return ColorDrawable(this.getColorFromAttr(resid))
}

fun Context.defaultNativeTemplateStyle(): NativeTemplateStyle? {
    val colorDrawable = this.getColorDrawableFromAttr(R.attr.new_release)
